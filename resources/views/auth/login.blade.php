...
<body>
    ...
    <header
        class="d-flex flex-wrap justify-content-center py-3 mb-0 border-bottom navbar navbar-expand-lg navbar-light bg-light sticky-top">
    ...
    <div class="container mt-5 d-flex justify-content-start align-items-center">
        ...
        <div class="form-inicio" style="width: 500px;">
            <h2 class="text-center mb-4 card-title">Iniciar sesión</h2>
            ...
            <form action="#" method="POST">
                ...
                <button type="submit" class="btn btn-primary w-100 button">Iniciar sesión</button>
            </form>
